...
export default function EmpleadoForm() {
  ...
  // Simulación de la carga del JSON (puedes reemplazar esto con tu fetch de Flask/MongoDB)
  useEffect(() => {
    const jsonDeMongoDB = {
      "IdEmpleado": "N/A",
      "Nombres": "Sebastian",
      ...
      "Extension": "11167",
      "email": "sebastian.acosta@chihuahua.gob.mx",
      "CentroTrabajo": "Coordinacion de Politica Digital",
      "UnidadAdministrativa": "Departamento de Desarrollo y Ciberseguridad",
      "Direccion": "C. Aldama",
      "NumeroExterior": "716",
      "NumeroInterior": "N/A",
      "Colonia": "Zona Centro",
      ...
      "Municipio": "Chihuahua",
      "Pais": "México",
      "Foto": "/Fotos/sebastian-Acosta-Ortiz.jpeg",
      "Activo": true
    };

    // Mapeamos las claves del JSON de la Base de Datos al estado local en CamelCase
    setFormData({
      ...
      pais: jsonDeMongoDB.Pais,
      activo: jsonDeMongoDB.Activo,
    });

    // La foto no se asigna al input de tipo file por seguridad del navegador,
    // pero si necesitas mostrar una vista previa de la foto actual guardada en el servidor,
    // podrías guardar 'jsonDeMongoDB.Foto' en un estado separado para renderizar un tag <img />.
  }, []);
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Al enviar a Flask, puedes construir un FormData para enviar tanto los textos como el archivo binario
    ...
    console.log("Datos listos para enviar a Flask:", formData, foto);
  };
